...
PERMISSION_CATALOG = tuple(
    ...
    for code, label in (
        ...
        ("behavior.add_studentpointentry", "إضافة نقاط طالب"),
        ("behavior.change_studentpointentry", "تعديل نقاط طالب"),
        ("behavior.delete_studentpointentry", "حذف نقاط طالب"),
        ("behavior.view_studentpointentry", "عرض نقاط الطلاب"),
